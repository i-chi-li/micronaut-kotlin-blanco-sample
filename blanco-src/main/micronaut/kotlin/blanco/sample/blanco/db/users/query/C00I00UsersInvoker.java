...
/**
 * C00I00UsersInvokerクラス (QueryInvoker)。
 *
 * 実行型SQL文をラッピングして各種アクセサを提供します。<br>
 * シングル属性: 有効 (期待する処理件数は1件)<br>
 */
public class C00I00UsersInvoker {
    /**
     ...
     */
    public C00I00UsersInvoker(final Connection connection) {
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "C00I00UsersInvoker : close()メソッドによるリソースの開放が行われていません。";
